[----nz@mathmadslinux2p ~]$ hdfs dfs -ls /data/ml
Found 9 items
...
[----nz@mathmadslinux2p ~]$ hdfs dfs -ls -h /data/ml
Found 9 items
...
[----nz@mathmadslinux2p ~]$ hdfs dfs -ls /data/msd/audio/attributes/                                                                                                            
# Found 13 items                                                                                                                                                                                  
...
[----nz@mathmadslinux2p ~]$ hdfs dfs -cat "/data/msd/audio/attributes/*" | awk -F',' '{print $2}' | sort | uniq                                                                 
# NUMERIC                                                                                                                                                                                         
# real                                                                                                                                                                                            
# real                                                                                                                                                                                            
# string                                                                                                                                                                                          
...
[----nz@mathmadslinux2p ~]$ hdfs dfs -ls /data/msd/genre
# Found 3 items
...
[----nz@mathmadslinux2p ~]$ hdfs dfs -ls -R /data/msd > files.txt
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd
...
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/main
# SIZE     DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 174.4 M  1.4 G                                  /data/msd/main/summary
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/tasteprofile
# SIZE     DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 2.0 M    16.2 M                                 /data/msd/tasteprofile/mismatches
# 488.4 M  3.8 G                                  /data/msd/tasteprofile/triplets.tsv
[----nz@mathmadslinux2p ~]$ for i in $(hdfs dfs -find /data/msd/audio/attributes -name '*.*')
> do
>   (hdfs dfs -cat $i | wc -l)
> done
# 21
...
# 421
# 1177
[----nz@mathmadslinux2p ~]$ for i in $(hdfs dfs -find /data/msd/audio/features -name 'msd-*')
> do
...
[----nz@mathmadslinux2p ~]$  /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00001.csv.gz
find: ‘/data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00001.csv.gz’: No such file or directory
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00001.csv.gz
# SIZE   DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 8.2 M  65.9 M                                 /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00001.csv.gz
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00002.csv.gz
# SIZE   DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 8.2 M  65.9 M                                 /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00002.csv.gz
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00003.csv.gz
# SIZE   DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 8.2 M  65.9 M                                 /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00003.csv.gz
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00004.csv.gz
# SIZE   DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 8.2 M  65.9 M                                 /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00004.csv.gz
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00005.csv.gz
# SIZE   DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 8.2 M  65.9 M                                 /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00005.csv.gz
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00006.csv.gz
# SIZE   DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 8.2 M  65.9 M                                 /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00006.csv.gz
[----nz@mathmadslinux2p ~]$ hdfs dfs -du -h -v /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00007.csv.gz
# SIZE   DISK_SPACE_CONSUMED_WITH_ALL_REPLICAS  FULL_PATH_NAME
# 7.9 M  63.0 M                                 /data/msd/audio/features/msd-jmir-area-of-moments-all-v1.0.csv/part-00007.csv.gz


[----nz@mathmadslinux2p ~]$ for i in $(hdfs dfs -find /data/msd/genre -name '*.*'); do    (hdfs dfs -cat $i | wc -l); done
# 422714
# 273936
# 406427
[----nz@mathmadslinux2p ~]$ for i in $(hdfs dfs -find /data/msd/main/summary -name '*.*'); do    (hdfs dfs -cat $i | wc -l); done
# 239762
# 480546
[----nz@mathmadslinux2p ~]$ for i in $(hdfs dfs -find /data/msd/tasteprofile/mismatches -name '*.*'); do   (hdfs dfs -cat $i | wc -l); done
# 938
# 19094
[----nz@mathmadslinux2p ~]$ hdfs dfs -cat /data/msd/tasteprofile/triplets.tsv/* | gunzip | wc -l
# 48373586


[----nz@mathmadslinux2p ~]$ hdfs dfs -ls /user/bpa78/outputs/msd
Found 6 items
...
[----nz@mathmadslinux2p ~]$ hdfs dfs -copyToLocal hdfs:///user/bpa78/outputs/msd/songPopularity/ /users/home/bpa78
[----nz@mathmadslinux2p ~]$ hdfs dfs -copyToLocal hdfs:///user/bpa78/outputs/msd/userActivity/ /users/home/bpa78
